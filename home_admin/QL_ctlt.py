...
from home_admin.view.view_ctlt.them_ctlt import them_ctlt
from view.view_ctlt.sua_ctlt import sua_ctlt
...
class Ui_Form(object):
    ...
    def setupUi(self, Form):
        ...
        self.label.setGeometry(QtCore.QRect(250, 10, 220, 50))
        font = QtGui.QFont()
        ...
        self.label.setGeometry(QtCore.QRect(200, 15, 300, 40))
        ...
        self.tableWidget.setHorizontalHeaderLabels(["ID tàu", "ID toa"])
    ...
    def nap_du_lieu(self):
        cn = Chuc_nang()
        cn.nap_du_lieu_vao_table(self.tableWidget,"SELECT tau.id,tau.ten,lich_trinh.id,lich_trinh.thoi_gian,lich_trinh.diem_don,lich_trinh.diem_den from tau , "
                                                  "chi_tiet_lich_trinh, lich_trinh where tau.id = chi_tiet_lich_trinh.id_tau and lich_trinh.id = chi_tiet_lich_trinh.id_lich",
                                 None ,["ID tàu","Tên tàu", "ID lịch trình","Thời gian", "Điểm đón", "Điểm đến"])
    ...
    def tim_kiem(self):
        ...
        sql = """
            SELECT * FROM chi_tiet_lich_trinh 
            WHERE id_tau LIKE %s OR id_lich LIKE %s
        """
        tham_so = (f"%{timkiem}%", f"%{timkiem}%")
        cn.nap_du_lieu_vao_table(self.tableWidget, sql, tham_so, ["ID tàu", "ID lịch"])

    def retranslateUi(self, Form):
        _translate = QtCore.QCoreApplication.translate
        Form.setWindowTitle(_translate("Form", "Quản lý chi tiết lịch trình"))
        self.label.setText(_translate("Form", "Quản lý chi tiết lịch trình"))
