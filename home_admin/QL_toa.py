...
from view.view_toa.them_toa import them_toa
from view.view_toa.sua_toa import sua_toa
...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.tableWidget.setHorizontalHeaderLabels(["ID", "Tên toa", "Tổng ghế", "Số ghế trống", "ID tàu"])
    ...
    def nap_du_lieu(self):
        cn = Chuc_nang()
        cn.nap_du_lieu_vao_table(self.tableWidget, "select * from toa", None, ["ID", "Tên toa", "Tổng ghế", "Số ghế trống", "ID tàu"])
    ...
    def tim_kiem(self):
        ...
        sql = """
            SELECT * FROM toa 
            WHERE id LIKE %s OR ten LIKE %s OR tong_ghe LIKE %s OR so_ghe_trong LIKE %s OR id_tau LIKE %s
        """
        tham_so = (f"%{timkiem}%", f"%{timkiem}%", f"%{timkiem}%", f"%{timkiem}%", f"%{timkiem}%")
        cn.nap_du_lieu_vao_table(self.tableWidget, sql, tham_so, ["ID", "Tên", "Tổng ghế", "Số ghế trống", "Tàu"])



    def retranslateUi(self, Form):
        _translate = QtCore.QCoreApplication.translate
        Form.setWindowTitle(_translate("Form", "Quản lý toa"))
        self.label.setText(_translate("Form", "Quản lý toa"))
