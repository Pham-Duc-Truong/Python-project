...
from view.view_ND.them_ND import them_nd
from view.view_ND.sua_ND import sua_nd
...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.tableWidget.setHorizontalHeaderLabels(["ID", "Tài khoản", "Mật khẩu", "Vai trò"])
    ...
    def nap_du_lieu(self):
        cn = Chuc_nang()
        cn.nap_du_lieu_vao_table(self.tableWidget, "select * from nguoi_dung", None, ["ID", "Tài khoản", "Mật khẩu", "Vai trò"])
    ...
    def tim_kiem(self):
        ...
        sql = """
            ...
            WHERE id LIKE %s OR tai_khoan LIKE %s OR mat_khau LIKE %s OR vai_tro LIKE %s
        """
        tham_so = (f"%{timkiem}%", f"%{timkiem}%", f"%{timkiem}%", f"%{timkiem}%")
        cn.nap_du_lieu_vao_table(self.tableWidget, sql, tham_so, ["ID", "Tài khoản", "Mật khẩu", "Vai trò"])


    def retranslateUi(self, Form):
        _translate = QtCore.QCoreApplication.translate
        Form.setWindowTitle(_translate("Form", "Quản lý người dùng"))
        self.label.setText(_translate("Form", "Quản lý người dùng"))
