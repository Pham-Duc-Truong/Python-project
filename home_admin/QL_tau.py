...
from PyQt6 import QtCore, QtGui, QtWidgets
from view.view_tau.them_tau import them_tau
from view.view_tau.sua_tau import sua_tau
...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.tableWidget.setHorizontalHeaderLabels(["ID", "Tên tàu", "Số toa"])
        ...
        self.pushButton_2.setIcon(QtGui.QIcon("C:/Users/DELL GAMING/PychamProjects/BTL_by/image/add.png"))
    ...
    def nap_du_lieu(self):
        cn = Chuc_nang()
        cn.nap_du_lieu_vao_table(self.tableWidget, "select * from tau", None, ["ID", "Tên", "Số toa"])
    ...
    def tim_kiem(self):
        ...
        sql = """
            SELECT * FROM tau 
            WHERE id LIKE %s OR ten LIKE %s OR so_toa LIKE %s
        """
        tham_so = (f"%{timkiem}%", f"%{timkiem}%", f"%{timkiem}%")
        cn.nap_du_lieu_vao_table(self.tableWidget, sql, tham_so, ["ID", "Tên", "Số toa"])



    def retranslateUi(self, Form):
        _translate = QtCore.QCoreApplication.translate
        Form.setWindowTitle(_translate("Form", "Quản lý tàu"))
        self.label.setText(_translate("Form", "Quản lý tàu"))
