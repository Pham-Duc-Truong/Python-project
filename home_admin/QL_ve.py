...
from  view.view_ve.sua_ve import sua_ve
from view.view_ve.them_ve import them_ve
...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.tableWidget.setHorizontalHeaderLabels(["ID","Giá tiền", "Tên toa", "Tên tàu", "ID khách hàng", "ID ghế ngồi"])
    ...
    def nap_du_lieu(self):
        cn = Chuc_nang()
        cn.nap_du_lieu_vao_table(self.tableWidget, "select * from ve_tau", None, ["ID","Giá tiền", "Tên toa", "Tên tàu", "ID khách hàng", "ID ghế ngồi"])
    ...
    def tim_kiem(self):
        ...
        sql = """
            SELECT * FROM ve_tau
            WHERE id LIKE %s OR gia_tien LIKE %s OR ten_toa LIKE %s OR ten_tau LIKE %s OR id_kh LIKE %s OR id_ghe_ngoi LIKE %s
        """
        tham_so = (f"%{timkiem}%", f"%{timkiem}%", f"%{timkiem}%", f"%{timkiem}%", f"%{timkiem}%", f"%{timkiem}%")
        cn.nap_du_lieu_vao_table(self.tableWidget, sql, tham_so, ["ID", "Giá tiền", "Tên toa", "Tên tàu", "ID khách hàng", "ID ghé ngồi"])

    def retranslateUi(self, Form):
        _translate = QtCore.QCoreApplication.translate
        Form.setWindowTitle(_translate("Form", "Quản lý vé tàu"))
        self.label.setText(_translate("Form", "Quản lý vé tàu"))
