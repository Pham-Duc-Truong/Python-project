...
class them_ctlt(object):
    ...
    def setupUi(self, Form):
        ...
        self.lb_id_tau.setGeometry(QtCore.QRect(90, 76, 80, 40))
        ...
        self.combo_tau.setGeometry(QtCore.QRect(180, 80, 211, 31))
        self.combo_tau.setObjectName("combo_id_tau")

        self.lb_lich = QtWidgets.QLabel(parent=Form)
        self.lb_lich.setGeometry(QtCore.QRect(90, 124, 80, 40))
        ...
        self.combo_lich_trinh.setGeometry(QtCore.QRect(180, 130, 211, 31))
        ...
        self.btn_sua.clicked.connect(self.them)
    ...
    def them(self):
        try:
            ...
            kn.thuc_thi("INSERT INTO chi_tiet_lich_trinh (id_tau, id_lich) VALUES (%s, %s)", (idtau, idlich))
            kn.ngat_ket_noi()
    ...
    def nap_gia_tri(self):
        if self.gia_tri:
            self.combo_tau.setPlainText(self.gia_tri[0])
            self.combo_lich_trinh.setPlainText(self.gia_tri[1])
    ...
    def retranslateUi(self, Form):
        ...
        self.lb_tieu_de.setText(_translate("Form", "Thêm chi tiết lịch trình"))
        self.lb_id_tau.setText(_translate("Form", "ID tàu"))
        self.lb_lich.setText(_translate("Form", "ID lịch"))
        self.btn_sua.setText(_translate("Form", "Thêm"))
