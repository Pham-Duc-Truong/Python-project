...
from view.view_GN.them_GN import them_gn
from view.view_GN.sua_GN import sua_gn
...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        QWidget {
            ...
            background-color: #EEEEEE;         /* Màu nền đen */
        ...
        self.tableWidget.setHorizontalHeaderLabels(["ID", "Tình trạng", "ID toa"])
    ...
    def nap_du_lieu(self):
        cn = Chuc_nang()
        cn.nap_du_lieu_vao_table(self.tableWidget, "select * from ghe_ngoi", None, ["ID", "Tình trạng", "ID toa"])
    ...
    def tim_kiem(self):
        ...
        sql = """
            ...
            WHERE id LIKE %s OR tinh_trang LIKE %s OR id_toa LIKE %s
        """
        tham_so = (f"%{timkiem}%", f"%{timkiem}%", f"%{timkiem}%")
        cn.nap_du_lieu_vao_table(self.tableWidget, sql, tham_so, ["ID", "Tình trạng", "ID_toa"])

    def retranslateUi(self, Form):
        _translate = QtCore.QCoreApplication.translate
        Form.setWindowTitle(_translate("Form", "Quản lý ghế ngồi"))
        self.label.setText(_translate("Form", "Quản lý ghế ngồi"))
