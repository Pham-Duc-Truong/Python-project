...
from view.view_lt.them_lt import them_lich_trinh
from view.view_lt.sua_lt import sua_lich_trinh
...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.tableWidget.setHorizontalHeaderLabels(["ID", "Thời gian", "Điểm đón", "Điểm đến"])
    ...
    def nap_du_lieu(self):
        cn = Chuc_nang()
        cn.nap_du_lieu_vao_table(self.tableWidget, "select * from lich_trinh", None, ["ID", "Thời gian", "Điểm đón", "Điểm đến"])

    def them(self):
        self.Form = QtWidgets.QMainWindow()
        self.ui = them_lich_trinh()
    ...
    def sua(self):
        ...
        if len(gia_tri) > 1:
            self.Form = QtWidgets.QMainWindow()
            self.ui = sua_lich_trinh(gia_tri)
            self.ui.setupUi(self.Form)
            self.Form.show()
    ...
    def tim_kiem(self):
        ...
        sql = """
            ...
            WHERE id LIKE %s OR thoi_gian LIKE %s OR diem_don LIKE %s OR diem_den LIKE %s
        """
        tham_so = (f"%{timkiem}%", f"%{timkiem}%", f"%{timkiem}%", f"%{timkiem}%")
        cn.nap_du_lieu_vao_table(self.tableWidget, sql, tham_so, ["ID", "Thời gian", "Điểm đón", "Điểm đến"])

    def retranslateUi(self, Form):
        _translate = QtCore.QCoreApplication.translate
        Form.setWindowTitle(_translate("Form", "Quản lý lịch trình"))
        self.label.setText(_translate("Form", "Quản lý lịch trình"))
